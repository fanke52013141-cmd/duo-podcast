...
PROMPT = ("图1是男主播角色，图2是女主播角色，图3是播客录音棚场景。"
          "把图1和图2中的两位角色一字不差地照搬进图3的场景：男主播保持深棕色短发、藏蓝色针织衫内搭白T，坐在长桌左侧；"
          "女主播保持黑色齐肩短发、黄色发卡、暖橙色连帽卫衣，坐在长桌右侧。两人各自面前一支桌面麦克风（沿用图3原有的两支麦克风），"
          "面向镜头自然交谈的姿态。严格保持图3的场景不变：浅米色墙面、原木长桌、桌上绿植、背景书架、暖色灯串、落地灯、米色扶手椅、整体暖色调，"
